        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 rounded-lg w-full bg-card border border-input text-base text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 md:text-sm"
            />
          </div>
